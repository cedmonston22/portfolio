  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col px-5 pb-5 pt-4">
        ...
        {/* Links as buttons */}
        {hasLinks && (
          <div className="mt-4 flex flex-wrap gap-2.5 border-t border-border-subtle pt-4">
            {project.liveUrl && (
              <a
                href={project.liveUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-lg border border-border-subtle bg-bg-hover px-4 py-2 text-xs font-medium text-text-secondary transition-all hover:border-gold/30 hover:text-gold"
              >
                <svg
                  className="h-4 w-4"
                  fill="none"
